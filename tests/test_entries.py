...
class TestAccounts(unittest.TestCase):
    ...
    def test_get_entries(self):
        ...
        self.assertEquals(rp['message'], "entries have been found")
    ...
    def test_put_delete_entry(self):
        # signs up user
        signup = self.client.post('/api/v1/auth/signup', data=json.dumps(self.the_data), content_type='application/json')
        # user signs in
        results = self.client.post(
            '/api/v1/auth/signin', data=json.dumps(self.data),
            content_type='application/json') 
        ...
        new_response = self.client.put(
            '/api/v1/entries/3',
            content_type='application/json',
            headers=header, data=json.dumps({"title": "andela", "story": "bootcamp"}))
